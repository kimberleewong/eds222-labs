...
2.  What does the intercept tell you, in words?
    ...
    The intercept is saying that when your engine displacement (in litres) is 0, the miles per gallon is 35.79.

3.  What does the coefficient on `displ` tell you, in words?

    The coefficient on displ is the slope and it is -3.76. So, as the engine displacement increases, the efficiency decreases.

4.  What does the coefficient estimate on the 2008 vintage indicator variable (`year2008`) tell you, in words?

    The coefficient tells us that the intercept on 2008 cars is 0.344 bigger than the 1999 cars (reference)

5.  What does the coefficient on `displ:year2008` tell you, in words?[^1]

    This is the change in slope between the original and the one that includes the interaction between displacement and year. It is 0.305 larger, so it is slightly steeper than the original.
